...
\newtheorem{definicija}{Hffkdosopjdfs}
}
...
\begin{definicija}
      ...
      v magičnem kvadratu imenujemo \pojem{\color{purple}magična konstanta}. 
\end{definicija}
...
\begin{table}[htp]
  ...
  \multicolumn{6}{c}{\textbf{Točna vrednost}}       & \textbf{Približek} \\ \midrule
   red & 1 & 2 & 3 & 4 & 5 & 6 \\ 
   število kvadratov & 1 & 0 & 1 & 880 & 275305224 & \texttt{!!} \\ 
   \bottomrule
  \end{tabular}
  \label{table:stevila}
\end{table}
...
iz leta 1982~\cite{berlekamp}. Število normalnih kvadratov reda 5 je izračunal
